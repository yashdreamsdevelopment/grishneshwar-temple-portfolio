    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 mb-6">
              One of the sacred 12 Jyotirlingas of Lord Shiva, nestled in the historic region of Aurangabad,
              Maharashtra.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/#directions" className="text-gray-400 hover:text-white transition-colors">
                  How to Reach
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/visiting-hours" className="text-gray-400 hover:text-white transition-colors">
                  Visiting Hours
                </Link>
              </li>
              <li>
                <Link href="/dress-code" className="text-gray-400 hover:text-white transition-colors">
                  Dress Code
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/nearby-attractions" className="text-gray-400 hover:text-white transition-colors">
                  Nearby Attractions
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">Verul, Ellora, Aurangabad District, Maharashtra, India - 431102</span>
              </li>
              <li className="flex items-center">
                <Phone className="h-5 w-5 text-orange-500 mr-3" />
                <span className="text-gray-400">+91 240 2400620</span>
              </li>
              <li className="flex items-center">
                <Mail className="h-5 w-5 text-orange-500 mr-3" />
                <span className="text-gray-400">info@grishneshwartemple.org</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
          <p>© {new Date().getFullYear()} Grishneshwar Temple Trust. All rights reserved.</p>
